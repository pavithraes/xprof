...
http_archive(
    ...
    strip_prefix = "tensorflow-ec16a806b7397cd9daf3e7d4505b19e8bbffefcc",
    urls = [
        "https://github.com/tensorflow/tensorflow/archive/ec16a806b7397cd9daf3e7d4505b19e8bbffefcc.zip",
    ],
)
