...
#ifndef XPROF_CONVERT_XPLANE_TO_DCN_COLLECTIVE_STATS_H_
#define XPROF_CONVERT_XPLANE_TO_DCN_COLLECTIVE_STATS_H_
...
#endif  // XPROF_CONVERT_XPLANE_TO_DCN_COLLECTIVE_STATS_H_
