...
#ifndef THIRD_PARTY_XPROF_CONVERT_ROOFLINE_MODEL_PROCESSOR_H_
#define THIRD_PARTY_XPROF_CONVERT_ROOFLINE_MODEL_PROCESSOR_H_
...
class RooflineModelProcessor : public OpStatsProcessor {
 public:
  explicit RooflineModelProcessor(
...
REGISTER_PROFILE_PROCESSOR("roofline_model", RooflineModelProcessor);

}  // namespace xprof

#endif  // THIRD_PARTY_XPROF_CONVERT_ROOFLINE_MODEL_PROCESSOR_H_
